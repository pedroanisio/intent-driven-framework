...
def root_fc_list : List FalsifiableClaim := [
  ...
  { id := "FC-02"
    ...
    evidence := "Traversable within the framework's own documents; not yet tested externally" },
  { id := "FC-03"
  ...
  { id := "FC-05"
    ...
    evidence := "The root intent contains all definitions; no external adopter has tested this" },
  { id := "FC-06"
    ...
    status := .supported
    evidence := "Six transitions demonstrate consistent version semantics" },
  { id := "FC-07"
